...
//    CGRect rect = self.bounds;
    [_imageTip sizeWith:CGSizeMake(73, 73)];
    [_imageTip layoutParentHorizontalCenter];
    [_imageTip alignParentTopWithMargin:34];
    
    [_countdownTip sameWith:_imageTip];
    
    [_tip sizeWith:CGSizeMake(140, 20)];
    [_tip layoutParentHorizontalCenter];
    [_tip alignParentBottomWithMargin:24];
}
