...
typedef void(^ChatSoundStartRecordCompletion)(TSIMMsg *willSendSoundMsg);
typedef void(^ChatSoundCancelRecordCompletion)(TSIMMsg *willSendSoundMsg);
typedef void(^ChatSoundStopRecordCompletion)(TSIMMsg *willSendSoundMsg);
