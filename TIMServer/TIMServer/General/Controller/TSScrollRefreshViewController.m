//
//  TSScrollRefreshViewController.m
//  TIMServer
//
...
@interface TSScrollRefreshViewController ()
{
...
@implementation TSScrollRefreshViewController
...
- (void)pinHeaderView
{
    [UIView animateWithDuration:0.3 animations:^(void) {
        self->_refreshScrollView.contentInset = UIEdgeInsetsMake([self headerRefreshHeight], 0, 0, 0);
        [self->_headerView loading];
    }];
}
...
{
    [UIView animateWithDuration:0.3 animations:^(void){
        self->_refreshScrollView.contentInset = UIEdgeInsetsZero;
        [self->_headerView loadingOver];
...
{
    [UIView animateWithDuration:0.3 animations:^(void) {
        self->_refreshScrollView.contentInset = UIEdgeInsetsMake(0, 0, [self footerLoadMoreHeight], 0);
    }];
}
