...
- (instancetype)initDefaultSubGroup
{
    ...
    {
        _isFold = YES;
        _friends = [[TSSafeMutableArray alloc] init];
    }
    return self;
}
...
- (instancetype)initWith:(TIMFriendGroupWithProfiles *)group
{
    if (self = [super init])
    {
        ...
        {
            TSIMUser *user = [[TSIMUser alloc] initWithUserInfo:u];
...
//        [[TSIMAPlatform sharedInstance].contactMgr saveSubGroupStateInfoToLocal];
    }
}
