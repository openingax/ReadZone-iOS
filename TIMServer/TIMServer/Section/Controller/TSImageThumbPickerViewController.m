//
//  TSImageThumbPickerViewController.m
//  TIMServer
//
...
@interface TSImageThumbPickerViewController ()

@end

@implementation TSImageThumbPickerViewController
...
- (UIButton *)createSendBtn
{
    ...
    sendBtn.enabled = YES;
    sendBtn.titleLabel.font = kTimMiddleTextFont;
