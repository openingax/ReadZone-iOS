...
//            v.title = @"无";
//            v.file = nil;
//            v.face = [UIImage imageWithBundleAsset:@"greens_no"];
//            v;
//        })];
//        [_greenArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
...
//            v.face = [UIImage imageWithBundleAsset:@"greens_1"];
//            v;
//        })];
//        [_greenArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
...
//            v.face = [UIImage imageWithBundleAsset:@"greens_2"];
//            v;
//        })];
...
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"原图";
//            v.face = [UIImage imageWithBundleAsset:@"orginal"];
//            v;
//        })];
//
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"美白";
//            v.face = [UIImage imageWithBundleAsset:@"fwhite"];
//            v;
//        })];
//
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"浪漫";
//            v.face = [UIImage imageWithBundleAsset:@"langman"];
//            v;
//        })];
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"清新";
//            v.face = [UIImage imageWithBundleAsset:@"qingxin"];
//            v;
//        })];
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"唯美";
//            v.face = [UIImage imageWithBundleAsset:@"weimei"];
//            v;
//        })];
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"粉嫩";
//            v.face = [UIImage imageWithBundleAsset:@"fennen"];
//            v;
//        })];
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"怀旧";
//            v.face = [UIImage imageWithBundleAsset:@"huaijiu"];
//            v;
//        })];
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"蓝调";
//            v.face = [UIImage imageWithBundleAsset:@"landiao"];
//            v;
//        })];
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"清凉";
//            v.face = [UIImage imageWithBundleAsset:@"qingliang"];
//            v;
//        })];
//        [_filterArray addObject:({
//            V8LabelNode *v = [V8LabelNode new];
//            v.title = @"日系";
//            v.face = [UIImage imageWithBundleAsset:@"rixi"];
//            v;
//        })];
...
//    [mask_top setImage:[UIImage imageWithBundleAsset:@"video_record_mask_top"]];
...
//    [mask_buttom setImage:[UIImage imageWithBundleAsset:@"video_record_mask_buttom"]];
...
//    [_btnBeauty setImage:[UIImage imageWithBundleAsset:@"beautyex"] forState:UIControlStateNormal];
...
//    minumumImageView.image = [UIImage imageWithBundleAsset:@"bubble"];
...
//    btnClose.center = CGPointMake(offsetX , centerY);
    btnClose.center = CGPointMake(_btnStartRecord.center.x/2, _btnStartRecord.center.y);
...
//    _btnCamera.center = CGPointMake(offsetX - BUTTON_CONTROL_SIZE , centerY);
    _btnCamera.center = CGPointMake(self.view.frame.size.width * 3 / 4 , _btnStartRecord.center.y);
...
-(void)startVideoRecord
{
    ...
    [_btnStartRecord setImage:[UIImage imageWithBundleAsset:@"stoprecord"] forState:UIControlStateNormal];
    [_btnStartRecord setImage:[UIImage imageWithBundleAsset:@"stoprecord_press"] forState:UIControlStateSelected];
...
//    if (_bottomViewShow)
//    {
//        [_btnBeauty setImage:[UIImage imageWithBundleAsset:@"beautyex_press"] forState:UIControlStateNormal];
//    }
//    else
//    {
//        [_btnBeauty setImage:[UIImage imageWithBundleAsset:@"beautyex"] forState:UIControlStateNormal];
...
//#endif
    ...
    [_beautyBtn setImage:[UIImage imageWithBundleAsset:@"white_beauty"] forState:UIControlStateNormal];
    [_beautyBtn setImage:[UIImage imageWithBundleAsset:@"white_beauty_press"] forState:UIControlStateSelected];
    ...
    [_filterBtn setImage:[UIImage imageWithBundleAsset:@"beautiful"] forState:UIControlStateNormal];
    [_filterBtn setImage:[UIImage imageWithBundleAsset:@"beautiful_press"] forState:UIControlStateSelected];
...
//    [_motionBtn setImage:[UIImage imageWithBundleAsset:@"move"] forState:UIControlStateNormal];
//    [_motionBtn setImage:[UIImage imageWithBundleAsset:@"move_press"] forState:UIControlStateSelected];
...
//    [_greenBtn setImage:[UIImage imageWithBundleAsset:@"greens"] forState:UIControlStateNormal];
//    [_greenBtn setImage:[UIImage imageWithBundleAsset:@"greens_press"] forState:UIControlStateSelected];
...
//#endif
    ...
    [_sdBeauty setThumbImage:[UIImage imageWithBundleAsset:@"slider"] forState:UIControlStateNormal];
    [_sdBeauty setMinimumTrackImage:[UIImage imageWithBundleAsset:@"green"] forState:UIControlStateNormal];
    [_sdBeauty setMaximumTrackImage:[UIImage imageWithBundleAsset:@"gray"] forState:UIControlStateNormal];
...
//#endif
    ...
    [_sdWhitening setThumbImage:[UIImage imageWithBundleAsset:@"slider"] forState:UIControlStateNormal];
    [_sdWhitening setMinimumTrackImage:[UIImage imageWithBundleAsset:@"green"] forState:UIControlStateNormal];
    [_sdWhitening setMaximumTrackImage:[UIImage imageWithBundleAsset:@"gray"] forState:UIControlStateNormal];
...
//    _sdBigEye.value = 0;
//    [_sdBigEye setThumbImage:[UIImage imageWithBundleAsset:@"slider"] forState:UIControlStateNormal];
//    [_sdBigEye setMinimumTrackImage:[UIImage imageWithBundleAsset:@"green"] forState:UIControlStateNormal];
//    [_sdBigEye setMaximumTrackImage:[UIImage imageWithBundleAsset:@"gray"] forState:UIControlStateNormal];
...
//    _sdSlimFace.value = 0;
//    [_sdSlimFace setThumbImage:[UIImage imageWithBundleAsset:@"slider"] forState:UIControlStateNormal];
//    [_sdSlimFace setMinimumTrackImage:[UIImage imageWithBundleAsset:@"green"] forState:UIControlStateNormal];
//    [_sdSlimFace setMaximumTrackImage:[UIImage imageWithBundleAsset:@"gray"] forState:UIControlStateNormal];
...
//    _filterPickerView.selectedMaskView = [[UIImageView alloc] initWithImage:[UIImage imageWithBundleAsset:@"filter_selected"]];
//
...
//    _greenPickerView.selectedMaskView = [[UIImageView alloc] initWithImage:[UIImage imageWithBundleAsset:@"greens_selected.png"]];
//    _greenIndex = 0;
...
//            break;
//    }
//    [[TXUGCRecord shareInstance] setFilter:[UIImage imageWithBundleAsset:lookupFileName]];
//}
...
//    frameRC.origin.y = kIsiPhoneX ? frameRC.size.height - BUTTON_RECORD_SIZE - 26 : frameRC.size.height - 100;
    frameRC.origin.y = _btnStartRecord.origin.y - 44;
