...
-(void)initPreviewUI
{
    ...
    [btnDelete setImage:[UIImage imageNamed:@"micro_delete"] forState:UIControlStateNormal];
    [btnDelete setImage:[UIImage imageNamed:@"micro_delete_press"] forState:UIControlStateSelected];
...
-(void)onBtnShareClicked
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(previewVideoPath:)])
    {
        [self.delegate previewVideoPath:_recordResult.videoPath];
    }
    [self.navigationController popViewControllerAnimated:YES];
}
